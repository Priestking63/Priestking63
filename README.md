...
| **Предсказание цен на недвижимость с Авито** | Полный цикл разработки от парсера и очистки данных до сервиса с готовым фрондендом |  Python, Pandas, Jupyter Notebook, CatBoost, FastAPI, Streamlit |
...
4. **[Предсказаные цен на недвижимость с авито](https://github.com/Priestking63/real_estate_predictor)**
Небольшой пет-проект с полным циклом от парсинга данных до фронтенда.
